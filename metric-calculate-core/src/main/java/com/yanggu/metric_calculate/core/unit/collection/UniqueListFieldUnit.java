...
public class UniqueListFieldUnit<T extends Cloneable2<T>> implements CollectionUnit<T, UniqueListFieldUnit<T>>,
        UnlimitedMergedUnit<UniqueListFieldUnit<T>>, Value<Set<Object>>, Serializable, Iterable<T> {
    ...
    @Override
    public UniqueListFieldUnit<T> merge(UniqueListFieldUnit<T> that) {
        return internalMergeOp(that, false);
    }

    @Override
    public UniqueListFieldUnit<T> unlimitedMerge(UniqueListFieldUnit<T> that) {
        return internalMergeOp(that, true);
    }

    private UniqueListFieldUnit<T> internalMergeOp(UniqueListFieldUnit<T> that, boolean hasLimit) {
        if (that == null) {
            return this;
        }
    ...
    private UniqueListFieldUnit<T> originalMerge(Set<T> original, int limit, boolean hasLimit) {
     ...
     */
    @Override
    public UniqueListFieldUnit<T> add(T value) {
    ...
    public boolean equals(Object that) {
        ...
        UniqueListFieldUnit<T> thatUnit = (UniqueListFieldUnit) that;
