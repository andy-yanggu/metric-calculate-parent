...
public class AggregateNumberFieldProcessorTest {
    ...
    public void testInit5() throws Exception {
        ...
        AggregateNumberFieldProcessor<SumUnit<CubeDecimal>> aggregateNumberFieldProcessor =
                (AggregateNumberFieldProcessor<SumUnit<CubeDecimal>>)
                        FieldProcessorUtil.<SumUnit<CubeDecimal>>getBaseAggregateFieldProcessor(Collections.singletonList(udafParam), unitFactory, fieldMap);
    ...
    public void testProcessWithMock() throws Exception {
        ...
        AggregateNumberFieldProcessor<SumUnit<CubeDecimal>> aggregateNumberFieldProcessor =
                (AggregateNumberFieldProcessor<SumUnit<CubeDecimal>>)
                        FieldProcessorUtil.<SumUnit<CubeDecimal>>getBaseAggregateFieldProcessor(Collections.singletonList(baseUdafParam), unitFactory, fieldMap);
    ...
    public void testProcess_CovUnit() throws Exception {
        ...
        BaseAggregateFieldProcessor<CovUnit<CubeLong>> numberAggregateFieldProcessor =
