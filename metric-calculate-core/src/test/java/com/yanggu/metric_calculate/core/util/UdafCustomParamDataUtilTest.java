...
class UdafCustomParamDataUtilTest {
    ...
    @Test
    void testGetUdafCustomParamList_ListObject() {
        ...
        assertEquals("UdafCustomParamData(name=limit, displayName=长度限制, description=, dataType=Integer, defaultValue=10, update=false, notNull=false)", udafCustomParamDataList.getFirst().toString());
    }
