...
public interface MixUdafParamMapstruct extends BaseMapstruct<MixUdafParamDTO, MixUdafParamEntity> {
    ...
    com.yanggu.metric_calculate.core.pojo.udaf_param.MixUdafParam toCoreMixUdafParam(MixUdafParamEntity mixUdafParam);
