...
public class AggregateFunctionEntity extends BaseUserEntity implements Serializable {
    ...
    private List<AggregateFunctionFieldEntity> aggregateFunctionFieldList;
