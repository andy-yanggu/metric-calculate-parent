...
public class WindowParamVO extends BaseVO implements Serializable {
     ...
     * 状态窗口表达式列表
     */
    private List<AviatorExpressParamVO> statusExpressParamList;

    /**
     * 事件模式数据
     */
    private List<NodePatternVO> nodePatternList;
