 ...
 */
@Service
public class AtomAggregateFunctionParamRelationServiceImpl extends ServiceImpl<AtomAggregateFunctionParamRelationMapper, AtomAggregateFunctionParamRelation> implements AtomAggregateFunctionParamRelationService {
}