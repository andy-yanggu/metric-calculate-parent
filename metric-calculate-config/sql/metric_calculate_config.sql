...
(
  ...
  COLLATE = utf8mb4_0900_ai_ci COMMENT = '聚合函数'
  ROW_FORMAT = Dynamic;
...
(
  ...
  AUTO_INCREMENT = 1
  CHARACTER SET = utf8mb4
  COLLATE = utf8mb4_0900_ai_ci COMMENT = '聚合函数的字段'
  ROW_FORMAT = Dynamic;
...
(
  ...
  AUTO_INCREMENT = 1
  CHARACTER SET = utf8mb4
  COLLATE = utf8mb4_0900_ai_ci COMMENT = '聚合函数参数配置类'
  ROW_FORMAT = Dynamic;
...
(
  ...
  AUTO_INCREMENT = 2
  CHARACTER SET = utf8mb4
  COLLATE = utf8mb4_0900_ai_ci COMMENT = '聚合函数参数-基本聚合参数中间表'
  ROW_FORMAT = Dynamic;
...
(
  ...
  AUTO_INCREMENT = 2
  CHARACTER SET = utf8mb4
  COLLATE = utf8mb4_0900_ai_ci COMMENT = '聚合函数参数-映射聚合参数中间表'
  ROW_FORMAT = Dynamic;
...
(
  ...
  AUTO_INCREMENT = 2
  CHARACTER SET = utf8mb4
  COLLATE = utf8mb4_0900_ai_ci COMMENT = '聚合函数参数-混合聚合参数中间表'
  ROW_FORMAT = Dynamic;
...
(
  ...
  AUTO_INCREMENT = 12
  CHARACTER SET = utf8mb4
  COLLATE = utf8mb4_0900_ai_ci COMMENT = 'Aviator表达式配置'
  ROW_FORMAT = Dynamic;
...
(
  ...
  AUTO_INCREMENT = 1
  CHARACTER SET = utf8mb4
  COLLATE = utf8mb4_0900_ai_ci COMMENT = 'Aviator函数和Aviator函数实例中间表'
  ROW_FORMAT = Dynamic;
...
(
  ...
  AUTO_INCREMENT = 2
  CHARACTER SET = utf8mb4
  COLLATE = utf8mb4_0900_ai_ci COMMENT = 'Aviator函数'
  ROW_FORMAT = Dynamic;
...
(
  ...
  AUTO_INCREMENT = 1
  CHARACTER SET = utf8mb4
  COLLATE = utf8mb4_0900_ai_ci COMMENT = 'Aviator函数字段模板'
  ROW_FORMAT = Dynamic;
...
(
  ...
  AUTO_INCREMENT = 2
  CHARACTER SET = utf8mb4
  COLLATE = utf8mb4_0900_ai_ci COMMENT = 'Aviator函数实例'
  ROW_FORMAT = Dynamic;
...
(
  ...
  AUTO_INCREMENT = 2
  CHARACTER SET = utf8mb4
  COLLATE = utf8mb4_0900_ai_ci COMMENT = '派生指标'
  ROW_FORMAT = Dynamic;
...
(
  ...
  AUTO_INCREMENT = 2
  CHARACTER SET = utf8mb4
  COLLATE = utf8mb4_0900_ai_ci COMMENT = '派生指标聚合函数参数中间表'
  ROW_FORMAT = Dynamic;
...
(
  ...
  AUTO_INCREMENT = 1
  CHARACTER SET = utf8mb4
  COLLATE = utf8mb4_0900_ai_ci COMMENT = '派生指标和时间字段中间表'
  ROW_FORMAT = Dynamic;
...
(
  ...
  AUTO_INCREMENT = 2
  CHARACTER SET = utf8mb4
  COLLATE = utf8mb4_0900_ai_ci COMMENT = '派生指标-窗口参数中间表'
  ROW_FORMAT = Dynamic;
...
(
  ...
  AUTO_INCREMENT = 211
  CHARACTER SET = utf8mb4
  COLLATE = utf8mb4_0900_ai_ci COMMENT = '维度表'
  ROW_FORMAT = Dynamic;
...
(
  ...
  AUTO_INCREMENT = 1
  CHARACTER SET = utf8mb4
  COLLATE = utf8mb4_0900_ai_ci COMMENT = '维度字段'
  ROW_FORMAT = Dynamic;
...
(
  ...
  AUTO_INCREMENT = 1
  CHARACTER SET = utf8mb4
  COLLATE = utf8mb4_0900_ai_ci COMMENT = '维度字段选项'
  ROW_FORMAT = Dynamic;
...
(
  ...
  AUTO_INCREMENT = 2
  CHARACTER SET = utf8mb4
  COLLATE = utf8mb4_0900_ai_ci COMMENT = '混合聚合参数，多个聚合值的计算表达式中间表'
  ROW_FORMAT = Dynamic;
...
(
  ...
  AUTO_INCREMENT = 5
  CHARACTER SET = utf8mb4
  COLLATE = utf8mb4_0900_ai_ci COMMENT = '数据明细宽表'
  ROW_FORMAT = Dynamic;
...
(
  ...
  AUTO_INCREMENT = 19
  CHARACTER SET = utf8mb4
  COLLATE = utf8mb4_0900_ai_ci COMMENT = '宽表字段'
  ROW_FORMAT = Dynamic;
...
(
  ...
  AUTO_INCREMENT = 3
  CHARACTER SET = utf8mb4
  COLLATE = utf8mb4_0900_ai_ci COMMENT = '宽表字段表达式关系表'
  ROW_FORMAT = Dynamic;
...
(
  ...
  AUTO_INCREMENT = 1
  CHARACTER SET = utf8mb4
  COLLATE = utf8mb4_0900_ai_ci COMMENT = '时间字段'
  ROW_FORMAT = Dynamic;
...
(
  ...
  AUTO_INCREMENT = 1
  CHARACTER SET = utf8mb4
  COLLATE = utf8mb4_0900_ai_ci COMMENT = '窗口相关参数'
  ROW_FORMAT = Dynamic;
