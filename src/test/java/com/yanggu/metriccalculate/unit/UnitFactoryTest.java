...
public class UnitFactoryTest {
    ...
    public void createObjectiveUnit() throws Exception {
        ...
        MergedUnit unit = (MergedUnit) UnitFactory.initInstanceByValue("maxObject", keyValue, null);
    ...
    public void createNumericUnit() throws Exception {
        MergedUnit unit = (MergedUnit) UnitFactory.initInstanceByValue("sum", 100L, null);
    ...
    public void createCollectionUnit() throws Exception {
        KeyValue keyValue = new KeyValue(new Key(1), CloneableWrapper.wrap(101));
        MergedUnit unit = (MergedUnit) UnitFactory.initInstanceByValue("distinctCount", keyValue, null);
