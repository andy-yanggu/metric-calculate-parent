...
public class UniqueCountUnit<T extends Cloneable<T>> implements CollectionUnit<T, UniqueCountUnit<T>>,
    ...
    @Deprecated
    public UniqueCountUnit<T> merge(com.yanggu.metriccalculate.unit.obj.UniqueCountUnit<T> that) {
        original.merge(that.original());
        return this;
    }
    ...
    @Deprecated
    public UniqueCountUnit<T> unlimitedMerge(com.yanggu.metriccalculate.unit.obj.UniqueCountUnit<T> that) {
        original.unlimitedMerge(that.original());
        return this;
    }
