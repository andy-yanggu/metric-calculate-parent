package com.yanggu.metric_calculate.web.pojo.vo;
...
public class Result<T> implements Serializable {
    ...
    public static <T> Result<T> create(boolean success, T data, ResultCode resultCode) {
        return new Result<>(success, data, resultCode);
    }
