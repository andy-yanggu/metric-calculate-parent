...
public class MetricDataController {
    ...
    public ApiResponse<Object> deleteDeriveData(@NotNull @ApiParam("数据明细宽表id") @RequestParam Long tableId,
                                                @NotNull @ApiParam("派生指标id") @RequestParam Long deriveId,
                                                @NotEmpty @ApiParam(value = "维度json数据") @RequestBody LinkedHashMap<String, Object> dimensionMap) {
