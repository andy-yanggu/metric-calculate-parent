 ...
 * @param <OUT>      输出数据类型
 */
public abstract class AbstractValueOutComparableMapAggregateFunction<K, V, ValueACC, ValueOUT extends Comparable<? super ValueOUT>, OUT>
        extends AbstractMapAggregateFunction<K, V, ValueACC, ValueOUT, OUT> {
